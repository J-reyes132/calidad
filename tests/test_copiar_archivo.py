...
class TestAppium(unittest.TestCase):
    ...
    def test_copiar_archivo(self) -> None:
        ...
        self.driver.find_element(By.XPATH, '(//android.widget.RelativeLayout[@resource-id="com.amaze.filemanager:id/second"])[6]/android.widget.RelativeLayout[2]').click()
        ...
        WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//android.widget.TextView[@resource-id="android:id/title" and @text="Copy"]')))
        self.driver.find_element(By.XPATH, '//android.widget.TextView[@resource-id="android:id/title" and @text="Copy"]').click()

        WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH, '//android.widget.TextView[@resource-id="com.amaze.filemanager:id/snackBarTextTV"]')))
        self.driver.press_keycode(4)

        WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH, '(//android.widget.RelativeLayout[@resource-id="com.amaze.filemanager:id/second"])[4]/android.widget.RelativeLayout[2]')))
        ...
        self.driver.find_element(by=AppiumBy.ID, value='com.amaze.filemanager:id/snackBarActionButton').click()
        assert self.driver.page_source.__contains__('Pensum-TIC-UNIBE.pdf')
