...
class TestAppium(unittest.TestCase):
    ...
    def test_navegar_directorios(self) -> None:
        ...
        WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH, '(//android.widget.RelativeLayout[@resource-id="com.amaze.filemanager:id/second"])[5]')))
        self.driver.find_element(By.XPATH, '//android.widget.TextView[@resource-id="com.amaze.filemanager:id/firstline" and @text="Download"]').click()
        ...
        assert self.driver.find_element(by=AppiumBy.ID, value='com.amaze.filemanager:id/fullpath').text == '/storage/emulated/0/Download'
